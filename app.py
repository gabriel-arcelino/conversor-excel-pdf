...
# Função para navegar pelas pastas e encontrar os arquivos Excel
...
# Função principal para processar todos os arquivos Excel
def processar_arquivos_excel(diretorio_base, diretorio_destino_base):
    ...
    for arquivo in arquivos_excel:
        ...
        criar_estrutura_pastas(diretorio_destino_base, os.path.dirname(caminho_completo_pdf))
...
# Processar os arquivos Excel e gerar os PDFs
